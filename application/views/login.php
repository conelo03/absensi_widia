...
<head>
    ...
    <title>Absensi QR Code | Login</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto mt-5">
                    ...
                    <b>Sistem Informasi Absensi QR Code</b>
                </h3>
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('auth/login') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- <body style="background-image:url(<?php echo base_url() ?>assets/img/samsat.jpg);background-size:cover;" class="hold-transition login-page">
